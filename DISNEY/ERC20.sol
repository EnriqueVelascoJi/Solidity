...
interface IERC20 {
    ...
    //Funcion para que el cliente page a disney por la atraccion
    function transferDisney(address _cliente, address _recipient, uint256 _numTokens) external returns(bool);
...
contract ERC20Basic is IERC20 {
    ...
    function transferDisney(address _cliente, address _recipient, uint256 _numTokens) public override returns(bool) {
